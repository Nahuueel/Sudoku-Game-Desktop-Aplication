package sudoku.example.userinterface;
...
EventHandler<KeyEvent>{
    ...
    private static final Color BOARD_BACKGROUND_COLOR = Color.rgb(224, 224, 241);
    ...
    public UserInterfaceImpl(Stage stage){
        ...
        initializeUserIterface();
    }

    private void initializeUserIterface() {
        drawBackground(root);
        drawTittle(root);
    ...
    private void drawTextField(Group root2) {
    ...
    private void drawTittle(Group root2) {
    ...
    public void updateBoard(SudokuGame game) {
        for(int xIndex = 0; xIndex < 9; xIndex++){
            for(int yIndex = 0; yIndex < 9; yIndex++){
                ...
                String value = Integer.toString(game.getCopyOfGirdState()[xIndex][yIndex]);
